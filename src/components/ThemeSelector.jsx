...
export function ThemeSelector(props) {
  ...
  return (
    ...
    >
      ...
      >
        <LightIcon className="hidden h-4 w-4 fill-[#7743db] [[data-theme=light]_&]:block" />
        <DarkIcon className="hidden h-4 w-4 fill-[#7743db] [[data-theme=dark]_&]:block" />
